...
# python_packages documentation build
...
from python_packages import __version__ as release

# -- Project information -----------------------------------------------------

project = "python_packages"
copyright = "2021, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
texinfo_documents = [
    (
        ...
        author,
        "python_packages",
        "Project python_packages codebase.",
        "Data-Science",
    )
]
